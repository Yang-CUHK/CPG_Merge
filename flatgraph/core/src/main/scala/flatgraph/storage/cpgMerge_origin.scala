...
// //       
//         //if(!(nodeKind.isDefined && edgeKind.isDefined)) println("hehe")
...
//           // println(tt+newLength - g.nodesArray(nodeKind.map(_.toInt).getOrElse(0)).length == 2)
//           // if(tt+newLength - g.nodesArray(nodeKind.map(_.toInt).getOrElse(0)).length != 2 && oldLength == 0){
//           //   println(tt+newLength)
//           //   println(g.nodesArray(nodeKind.map(_.toInt).getOrElse(0)).length)
//           //   println("aaa")
//           // }
...
//           //   // println(g.nodesArray(nodeKind.map(_.toInt).getOrElse(0)).length)
//           //   // println(nodeKind.map(_.toInt).getOrElse(0))
//           //   // println(pos)
//           //   // println("!!!")
//           // }else{
//           //   println("true")
